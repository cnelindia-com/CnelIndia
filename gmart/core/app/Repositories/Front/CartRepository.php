...
class CartRepository
{
    ...
    public function store($request)
    {
        ...
        $item = Item::where('id',$input['item_id'])->select('id','name','photo','discount_price','previous_price','slug','item_type')->first();
	...
	public function promoStore($request)
	{
        ...
        if($promo_code){
            ...
            $discount = $this->getDiscount($promo_code->discount,$cartTotal);
