			...
			<div class="card o-hidden border-0 shadow-lg">
				<div class="card-body ">
					...
					<div class="row justify-content-center">
						<div class="col-lg-12">
								<form class="admin-form" action="{{ route('back.slider.store') }}" method="POST"
									...
									<div class="form-group">
										...
										<br>
											<img class="admin-img" src="{{  asset('assets/images/placeholder.png') }}"
												alt="No Image Found">
										<br>
										<span class="mt-1">{{ __('Image Size Should Be 130 x 40') }}</span>
									</div>
									...
									<div class="form-group">
										<label for="name">{{ __('Set Slider Image') }} *</label>
										<br>
											<img class="admin-img" src="{{  asset('assets/images/placeholder.png') }}"
												alt="No Image Found">
										<br>
										<span class="mt-1">{{ __('Image Size Should Be 1000 x 530 ') }}</span>
									</div>
