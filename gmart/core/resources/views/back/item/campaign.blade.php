...
<div class="container-fluid">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class="mb-0 bc-title"><b>{{ __('Campain Offer') }}</b></h3>
                </div>
        </div>
    </div>
	...
	<div class="card shadow mb-4">
        <div class="card-header">
            <h4 class="card-title">{{__('Product Added for Campain')}}</h4>
            <div class="row">
                <form action="{{route('back.campaign.store')}}" method="POST">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">{{__('Add To Campain')}}</button>
                        </div>
                    </div>
                </form>
            </div>
