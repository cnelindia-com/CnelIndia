                        ...
                        <nav class="site-menu">
                            <ul>
                                ...
                                <li class="t-h-dropdown">
                                    ...
                                    <div class="t-h-dropdown-menu">
                                        @if ($setting->is_faq == 1)
                                        <a href="{{route('front.faq')}}"><i class="icon-chevron-right pr-2"></i>{{__('Faq')}}</a>
                                        @endif
                                        @foreach (DB::table('pages')->wherePos(0)->orwhere('pos',2)->get() as $page)
                                        <a href="{{route('front.page',$page->slug)}}"><i class="icon-chevron-right pr-2"></i>{{$page->title}}</a>
                                        @endforeach
                                    </div>
                                </li>
...
<a class="announcement-banner absulute" href="{{asset('assets/images/'.$setting->announcement)}}"></a>
