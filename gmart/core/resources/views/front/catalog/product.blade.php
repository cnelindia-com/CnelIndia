...
<div class="container padding-bottom-1x mb-1">
  ...
  <div class="container  review-area">
    ...
    <div class="row">
        <div class="col-md-8">
              @forelse ($item->reviews->where('status',1) as $review)
              <div class="single-review">
                  <div class="comment">
                    <div class="comment-author-ava"><img src="{{asset('assets/images/'.$review->user->photo)}}" alt="Comment author"></div>
                ...
                @foreach ($related_items as $related)
                    <div class="slider-item">
                        <div class="product-card">
                            @if($related->stock != 0 || $item->item_type == 'digital')
                            ...
                            ">{{__('out of stock')}}</div>
                            @endif
                            <a class="product-thumb" href="{{route('front.product',$related->slug)}}"><img src="{{asset('assets/images/'.$related->photo)}}" alt="Product"></a>
