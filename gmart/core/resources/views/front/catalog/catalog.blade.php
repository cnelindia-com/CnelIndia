            ...
            @if($items->count() > 0)
                @if ($checkType != 'list')
                    ...
                    <div class="col-xxl-3 col-md-4 col-6">
                        ...
                        ">{{__('out of stock')}}</div>
                        @endif
                        <a class="product-thumb" href="{{route('front.product',$item->slug)}}"><img src="{{asset('assets/images/'.$item->photo)}}" alt="Product"></a>
                            ...
                            <div class="product-card product-list">
                                ...
                                @else
                                    ...
                                    <div class="product-card-inner">
                                        <div class="product-card-body">
                                            <h3 class="product-title"><a href="{{route('front.product',$item->slug)}}">
                                                {{ strlen(strip_tags($item->name)) > $name_string_count ? substr(strip_tags($item->name), 0, 55) : strip_tags($item->name) }}
                                            </a></h3>
                                            <div class="rating-stars">
                                                {!! renderStarRating($item->reviews->avg('rating')) !!}
                                            </div>
