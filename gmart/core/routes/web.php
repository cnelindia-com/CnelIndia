...
Route::group(['middleware'=>'permissions:Manage Settings'],function(){
  ...
  Route::post('/setting/visiable/update', 'Back\SettingController@visiable')->name('back.setting.visible.update');
  ...
  //----------- SECTION SETTING -----------//
  Route::get('section/setting','Back\SettingController@section')->name('back.setting.section');
  //------------ EMAIL TEMPLATE ------------
